...
public func pressureAltitude(ambientPressure: Pressure) -> Distance {
...
*/
func densityAltitude(ambientPressure ambientPressure: Pressure, temperature: Temperature, dewpoint: Temperature) -> Distance {
...
*/
func dewpoint(temperature temperature: Temperature, humidity: Double) -> Temperature {
    let temp_c = temperature --> TemperatureUnit.Celcius
 ...
 */
func humidity(temperature temperature: Temperature, dewpoint: Temperature) -> Double {
    let temp_c = temperature --> TemperatureUnit.Celcius
    let dewp_c = dewpoint --> TemperatureUnit.Celcius
...
*/
public func fieldElevation(ambientPressure ambientPressure: Pressure, barometricPressure: Pressure) -> Distance {
 ...
 */
public func barometricPressure(ambientPressure ambientPressure: Pressure, fieldElevation: Distance) -> Pressure {
    let pressure_mbar = ambientPressure --> PrefixedUnit(prefix: .Milli, baseUnit: PressureUnit.Bar)
...
/**
 ...
 - parameter fieldElevation: The field elevation above MSL
 */
public func ambientPressure(barometricPressure barometricPressure: Pressure, fieldElevation: Distance) -> Pressure {
